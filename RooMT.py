...
def roomDD():
    ...
    ra1=tkinter.Label(rootRD,text="Введите ID пациента")
    ra1.place(x=20,y=20)
...
def Room_all():
    ...
    r_head=tkinter.Label(rootR,text="Распределение комнат", bg="#73ACDA", fg='white', font="Times 16 bold")
    ...
    ratel=tkinter.Label(rootR, text="Номер палаты")
