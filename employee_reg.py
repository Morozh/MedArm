...
def emp_screen():
    ...
    rootE.geometry('1366x768')
    var = tkinter.StringVar(master=rootE)
    H=tkinter.Label(rootE,text="Регистрация сотрудника",fg='grey',font="Arial 10 bold")
    H.place(x=50,y=20)
    ...
    l7 = tkinter.Label(rootE, text="Опыт работы сотрудника")
    l7.place(x=50,y=230)
    ...
    t7.place(x=90,y=290)
    b1=tkinter.Button(rootE,text="Сохранить",command=inp)
    b1.place(x=60,y=320)
    b2=tkinter.Button(rootE,text="Удалить работника",command=delo)
    b2.place(x=110,y=320)
    b3=tkinter.Button(rootE,text="Выйти",command=ex)
